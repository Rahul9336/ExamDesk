...
<br><br>				<div class="1 level">
					...
					<br><br><br><br>
						...
						<em>HINT : PROVIDE THE HINT FOR THE DIRECTION</em>
						<p> 
						FOR EXAMPLE : THE ARROW DIRECTING TOWARDS UP SHOULD BE MOVING OR POINTING IN JUMPING PATTERN TOWARDS UPWARDS.
						</p>

						<p>1.	IDENTIFY THE SYMBOL POINTING DOWNWARDS</p>
						<label>
						  <input type="radio" name="pisL11" value="small" />
						  <img src="images/pisL11.png" width="50%" height="30%"/>
						</label>
		<label>
						  <input type="radio" name="pisL11" value="small" />
						  <img src="images/pisL12.png" width="50%" height="30%"/>
						</label>
						<label>
						  <input type="radio" name="pisL11" value="small" />
						  <img src="images/pisL13.png" width="50%" height="30%"/>
						</label>
						<label>
						  <input type="radio" name="pisL11" value="small" />
						  <img src="images/pisL14.png" width="50%" height="30%"/>
						</label><br>
						 <br>
