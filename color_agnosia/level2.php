...
<br><br>					<div class="3 21 level">																						<!-- LEVEL 3 STARTS-->
						...
						<form action="level2.php" method="POST">
							<p>1.	click on the black car</p>
					<img src="images/ca/cal21.png" alt="" usemap="#Map" />
					<map name="Map" id="Map">
						<label><area shape="poly" coords="126,199,299,196,306,276,116,281" />
						<input type="radio" name="cal21" value="clicked" />  black car
						</label>
					...
					<p>2.	FIND THE YELLOW COLORED EYE LENS</p>
					<img src="images/ca/cal22.png" alt="" usemap="#Map2" />
					<map name="Map2" id="Map2">
						<label><area shape="poly" coords="8,225,143,229,138,294,4,302" />
						<input type="radio" name="cal22" value="clicked" onchange =""/>  yellow lens
						</label>
					...
					<img src="images/ca/cal23.png" alt="" usemap="#Map3" />
					<map name="Map3" id="Map3">
						<label><area shape="poly" coords="30,55,31,118,59,121,60,56" />
						<input type="radio" name="cal23" value="clicked" onchange =""/>  blue lens
						</label>
						 ...
						 <button type="submit" name="lvl2cal" onclick="stopTimer();" class="btn btn-primary">Next</button><br><br>
						</form>	
<?php
