...
?>
			...
			<div class="col-sm-6">
				...
				<form action="ca41.php" method="POST">
						<p>IN THIS WE TRY BE SPECIFIC WITH THE BODY PARTS <br>1.	TAP ON THE ELBOW  </p>
					<img src="images/bsl31.png" alt="" usemap="#Map" />
					<map name="Map" id="Map">
						<label><area shape="poly" coords="447,192,471,295,546,267,543,196" onclick="c('q1');" />
						<area shape="poly" coords="167,228,163,284,226,296,239,235" onclick="c('q1');" />
						<input type="radio" name="bsL31" value="a" id="q1" />  
						</label>
					...
					<p>2.	TAP ON THE EARS</p>
					<img src="images/bsl32.png" alt="" usemap="#Map2" />
					<map name="Map2" id="Map2">
						<label><area shape="poly" coords="283,72,331,67,317,110,283,106" onclick="c('q2');"/>
						<input type="radio" name="bsL32" value="a" id="q2"/>  
						</label>
					...
					<p>3.	TAP ON THE FOREARMS</p>
					<img src="images/bsl33.png" alt="" usemap="#Map3" />
					<map name="Map3" id="Map3">
						<label><area shape="poly" coords="412,324,472,302,547,387,516,418" onclick="c('q3');" />
						<label><area shape="poly" coords="248,323,199,294,120,375,159,400" onclick="c('q3');"/>
						<input type="radio" name="bsL33" value="a" id="q3"/>  
						</label>
						 ...
						 <br>
						 <br><br><button type="submit" name="lvl3bs" onclick="stopTimer();" class="btn btn-primary">Next</button><br><br>
						</form>	
<?php
...
if(isset($_POST['lvl3bs']))
{
	...
	if($run){
		echo "<script>alert('Body Scheme Level 3 Succesfully Submitted')</script>";
